...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	Если ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда
		ВставитьВШапкуРеквизитКонтактноеЛицо(Форма)
	ИначеЕсли ИмяФормы = "Документ.ОплатаОтПокупателя.Форма.ФормаДокумента" Тогда
		ДобавитьВШапкуРеквизитКонтактноеЛицо(Форма)
...
#Область Доработки
//Выводит контактное лицо на форму
Процедура ВставитьВШапкуРеквизитКонтактноеЛицо(Форма) 
	НовыйЭлемент = Форма.Элементы.Вставить("Д_КонтактноеЛицо",Тип("ПолеФормы"),Форма.Элементы.ГруппаШапкаПраво);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.Д_КонтактноеЛицо";
КонецПроцедуры 

Процедура ДобавитьВШапкуРеквизитКонтактноеЛицо(Форма)
	ЕстьОснование = Форма.Элементы.Найти("Основание");
	Если не ЕстьОснование = Неопределено Тогда 
		НовыйЭлемент = Форма.Элементы.Вставить("Д_КонтактноеЛицо",Тип("ПолеФормы"),Форма.ЭтаФорма,Форма.Элементы.Основание);
	Иначе 
		НовыйЭлемент = Форма.Элементы.Вставить("Д_КонтактноеЛицо",Тип("ПолеФормы"),Форма.ЭтаФорма,Форма.Элементы.СуммаДокумента);
	КонецЕсли;
